...
export default function NewTableLab({
    title,
    data,
    columns,
    onAddClick,
                                    ...
                                    <tr>
                                        ...
                                        <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-s whitespace-nowrap p-4">
                                            <div>
                                                <button
                                                    type="button"
                                                    class={`inline-block px-6 py-2 bg-emerald-500 text-white font-medium text-xs leading-tight rounded shadow-md hover:bg-green-600 hover:shadow-lg focus:bg-green-600 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-green-700 active:shadow-lg transition duration-150 ease-in-out`}
